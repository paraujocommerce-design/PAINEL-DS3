...
O gerenciador de pacotes do projeto é o [Bun](https://bun.sh) (o repositório versiona `bun.lock`, não um `package-lock.json`/`yarn.lock`). Instale as dependências e rode com Bun, não npm/yarn.
