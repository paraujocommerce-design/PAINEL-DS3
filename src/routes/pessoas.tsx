...
export const Route = createFileRoute("/pessoas")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Área reservada para a futura gestão individual por função." },
      { property: "og:title", content: "Pessoas — Painel de Gestão DS3" },
      { property: "og:description", content: "Área reservada para a futura gestão individual por função." },
    ],
  }),
  component: Pagina,
});
  ...
  return (
    <ModulePage
      ...
      sections={[
        ...
        { title: "Acompanhamento individual", description: "Área reservada. Regras ainda não definidas." },
      ]}
    />
  );
}
